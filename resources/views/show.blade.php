...
@section('content')
    <!-- movie-info section starts-->
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <img src="{{'https://image.tmdb.org/t/p/w500/'.$movie['poster_path']}}" alt="sonic" class="w-64 md:w-96">
            <div class="md:ml-24">
                <div class="h2 text-4xl font-semibold">{{$movie['original_title']}}</div>
                ...
                <!-- Youtube trailer Model section starts -->
                <div x-data="{isOpen:false}">
                    ...
                    @endif
                    <div x-show="isOpen" x-transition.opacity style="background-color: rgba(0, 0, 0, .5);" class="fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto">
                ...
                <!-- Youtube trailer Model section ends -->
            </div>
        </div>
    </div>
    <!-- movie-info section ends-->
    <!-- movie-cast section starts-->
                    ...
                    @if($loop->index < 5)
                        <div class="mt-8">
                            <a href="#">
                                ...
                                @else
                                    <img src="https://via.placeholder.com/300x447" alt="poster">
                                @endif
                            </a>
                            <div class="mt-2">
    ...
    <!-- movie-cast section ends-->
    <!-- movie-images section starts-->
            ...
            <div x-show="isOpen" style="background-color: rgba(0, 0, 0, .5);" class="fixed top-0 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto">
                <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                    <div class="bg-gray-900 rounded">
                        ...
                        <div class="modal-body px-8 py-8">
                            <img :src="image" alt="poster"> <!-- image value coming from @click.prevent -->
                        </div>
                    </div>
                </div>
            </div>
            <!-- image model section ends -->
        </div>
    </div>
    <!-- movie-images section ends-->
@endsection
